...
TopDef : FnDef { AbsLatte.FnTopDef $1 }
       | 'class' Ident '{' ListClassDecl '}' { AbsLatte.ClassDef $2 $4 }
       | 'class' Ident 'extends' Ident '{' ListClassDecl '}' { AbsLatte.ClassExtDef $2 $4 $6 }
ListTopDef :: { [TopDef] }
ListTopDef : TopDef { (:[]) $1 } | TopDef ListTopDef { (:) $1 $2 }
ClassDecl :: { ClassDecl }
ClassDecl : FnDef { AbsLatte.MethodDef $1 }
          | Type Ident ';' { AbsLatte.FieldDef $1 $2 }
...
Expr6 : Ident { AbsLatte.EVar $1 }
      ...
      | 'new' Type '[' Expr ']' { AbsLatte.EArr $2 $4 }
      | 'new' Type { AbsLatte.EClass $2 }
      | Expr6 '[' Expr ']' { AbsLatte.EArrGet $1 $3 }
      | Expr6 '.' Ident { AbsLatte.EFieldGet $1 $3 }
      | Expr6 '.' Ident '(' ListExpr ')' { AbsLatte.EMethod $1 $3 $5 }
      | '(' Ident ')' 'null' { AbsLatte.ENull $2 }
      | '(' Expr ')' { $2 }
Expr5 :: { Expr }
